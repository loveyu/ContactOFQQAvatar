...
public class AboutActivity extends Activity {
	...
	private void setAboutContent(TextView tv) {
		...
		html = "<div><h3>程序信息</h3>"
				...
				+ "<div><h3>功能说明</h3>"
				+ "<p>可以通过批量导入的方式导入联系人QQ号，前提是要获取对应的信息，详见：<a href=\"http://www.loveyu.org/3151.html\">http://www.loveyu.org/3151.html</a></p>"
				+ "<p>其中广告屏蔽为一次有效，请谅解！要生存啊！</p></div>" + "<div><h3>反馈</h3>" + "<p>作者:<strong>恋羽</strong></p>"
				+ "<p>博客地址:<a href=\"http://www.loveyu.org\">http://www.loveyu.org</a></p></div>";
